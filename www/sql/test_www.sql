...
CREATE TABLE `test_www`  (
  `www_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '网站模块测试表主键',
  `www_msg` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '消息',
  `www_num` int(11) NULL DEFAULT NULL COMMENT '数量',
  ...
  PRIMARY KEY (`www_id`) USING BTREE
